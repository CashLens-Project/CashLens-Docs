# Documentação do CashLens

Esta pasta centraliza os principais documentos do projeto em formato PDF, organizados por artefato.

## Estrutura

- `documento-visao/`: versão em PDF do Documento de Visão do Sistema.
- `requisitos-software/`: versão em PDF do Documento de Requisitos de Software.
- `casos-de-uso/`: versão em PDF do Documento de Casos de Uso.
...
- [Documento de Visão do Sistema](./documento-visao/documento-visão.pdf)
- [Documento de Requisitos de Software](./requisitos-software/requisitos-de-software.pdf)
- [Documento de Casos de Uso](./casos-de-uso/casos-de-uso.pdf)
- [Documentação de Arquitetura do Sistema](./documentacao-arquitetura/documentacao-arquitetura.pdf)
- [Documentação de Interfaces e Prototipação](./documentacao-interfaces-e-prototipacao/documentação-interfaces-e-prototipação.pdf)
